...
[src/assert.ts:14](https://github.com/SirPepe/shed/blob/2ccbe12/src/assert.ts#L14)
...
[src/assert.ts:35](https://github.com/SirPepe/shed/blob/2ccbe12/src/assert.ts#L35)
