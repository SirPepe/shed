...
[src/assert.ts:12](https://github.com/SirPepe/shed/blob/1c0eb31/src/assert.ts#L12)
...
[src/assert.ts:32](https://github.com/SirPepe/shed/blob/1c0eb31/src/assert.ts#L32)
