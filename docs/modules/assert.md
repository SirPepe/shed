...
[src/assert.ts:22](https://github.com/SirPepe/shed/blob/debed7e/src/assert.ts#L22)
...
[src/assert.ts:43](https://github.com/SirPepe/shed/blob/debed7e/src/assert.ts#L43)
