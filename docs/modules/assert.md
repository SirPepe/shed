...
[src/assert.ts:22](https://github.com/SirPepe/shed/blob/5d7c4da/src/assert.ts#L22)
...
[src/assert.ts:43](https://github.com/SirPepe/shed/blob/5d7c4da/src/assert.ts#L43)
