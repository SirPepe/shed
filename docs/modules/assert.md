...
[src/assert.ts:22](https://github.com/SirPepe/shed/blob/3cb710a/src/assert.ts#L22)
...
[src/assert.ts:43](https://github.com/SirPepe/shed/blob/3cb710a/src/assert.ts#L43)
